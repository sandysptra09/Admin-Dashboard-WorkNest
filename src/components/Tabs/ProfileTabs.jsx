            ...
            <div className='flex flex-row gap-6'>
                <div className='w-full flex gap-4'>
                    ...
                    <div className='flex flex-col gap-2 items-start'>
                        <h3 className='text-base font-semibold '>Sandy Saputra</h3>
            ...
            <div className="">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className='flex flex-col gap-1'>
                        ...
                        <p className="text-sm font-medium">Sandy</p>
                    </div>
                    <div className='flex flex-col gap-1'>
                        <p className="text-sm text-gray-500">Last Name</p>
                        <p className="text-sm font-medium">Saputra</p>
                    </div>
                    <div className='flex flex-col gap-1'>
                        <p className="text-sm text-gray-500">Email Address</p>
                        <p className="text-sm font-medium">sandywork@manager.nest</p>
                    </div>
                    <div className='flex flex-col gap-1'>
                        <p className="text-sm text-gray-500">Phone</p>
                        <p className="text-sm font-medium">+62 8145 346 46</p>
                    </div>
                    <div className="flex flex-col gap-1">
                        <p className="text-sm text-gray-500">Bio</p>
                        <p className="text-sm font-medium">HR Manager in WorkNest Group</p>
                    </div>
                </div>
            </div>
        </div>
